<div class="app-bar fixed-top navy" data-role="appbar">
  <a class="app-bar-element branding" href="{{ url('operator') }}">   <!--<img src="https://media.giphy.com/media/bJnqyzhYlF8LS/giphy.gif" style="height: 38px; display: inline-block; margin-right: 10px;"> -->  <b>LSP Operator</b></a>
